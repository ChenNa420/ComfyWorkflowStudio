...
import { AlertTriangle, BadgeCheck, Braces, CircleX, Filter, RefreshCcw, Search, ShieldCheck, TriangleAlert } from 'lucide-vue-next'
...
<template>
  <section class="preflight-shell">
    <div class="preflight-head">
      <div>
        <span class="eyebrow">PHASE 1G-3 · PREFLIGHT CERTIFICATION</span>
